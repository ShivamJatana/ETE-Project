...
export default function Navbar() {
  ...
  <nav className=" navbar navbar-expand-lg bg-primary bg-dark border-bottom border-light" data-aos="fade-down" data-aos-duration="1500">
    <div className='container yo'>  
      ...
      <Link to ="/">
        <a id="logo" className="navbar-brand position-absolute " href="#"><img  src={require('../assets/png-clipart-metronome-origin-icon-thumbnail-removebg-preview.png')} height="80"width="120" alt=""></img> <span id="logoH"></span></a>
        ...
        <div className="collapse navbar-collapse justify-content-around" id="navbarSupportedContent">
          <ul className="navbar-nav  ">
            ...
            <li className="nav-item" id="hover">
              <a className="nav-link" href="https://store.steampowered.com/">Store</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#"><Link className=' Link2'  to="/about">About</Link></a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="https://steamcharts.com/">Top Games</a>
            </li>
            <li className="nav-item">
